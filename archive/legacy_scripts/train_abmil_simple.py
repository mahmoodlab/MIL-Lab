...
LEARNING_RATE = 1e-4
WEIGHT_DECAY = 1e-5
#NUM_FEATURES = 512  # Sample 512 patches for training
...
def main():
    ...
    # Step 3: Create model
    print("="*70)
    print("LOADING ABMIL FEATHER-24K MODEL")
    print("="*70 + "\n")
    ...
    plot_confusion_matrix(
        ...
        title='Confusion Matrix - ABMIL FEATHER-24K',
        output_path='confusion_matrix_abmil.png'
    )
