...
- **Lightweight supervised foundation models**: We provide **FEATHER**, *a lightweight supervised foundation model* that can easily be finetuned on consumer-grade GPUs, using orders of magnitude less parameters than other self-supervised slide foundation models while achieving competitive performance.
